...
<div class="container">
        ...
        <div id="awardInfoButton">
            ...
            var lang_award_info_ln2 = "<?= __("May be claimed for having contacted (heard) and received a QSL card from an amateur station located in each of at least 100 different guns (districts) of Japan."); ?>";
            var lang_award_info_ln3 = "<?= __("JCG-200, 300, 400, 500 and 600 will be issued as separate awards. A list of QSL cards should be arranged in order of JCG reference number, however names of guns may be omitted."); ?>";
