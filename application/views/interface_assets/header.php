							...
							<ul class="dropdown-menu header-dropdown">
								...
								<li><a class="dropdown-item dropdown-toggle dropdown-toggle-submenu" data-bs-toggle="dropdown" href="#">🇯🇵 <?= __("Japan"); ?></a>
									<ul class="submenu dropdown-menu">
										...
										<div class="dropdown-divider"></div>
										<li><a class="dropdown-item" href="<?php echo site_url('awards/waku'); ?>"><i class="fas fa-trophy"></i> <?= __("WAKU"); ?></a></li>
										<div class="dropdown-divider"></div>
										<li><a class="dropdown-item" href="<?php echo site_url('awards/aja'); ?>"><i class="fas fa-trophy"></i> <?= __("AJA"); ?></a></li>
										<div class="dropdown-divider"></div>
